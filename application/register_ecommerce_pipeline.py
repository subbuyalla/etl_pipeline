...
"""
Register ecommerce_etl in Metadata MySQL (does not replace stock_etl as active).

Run from repo root:
  python application/register_ecommerce_pipeline.py
"""
...
from application.src.pipelines import get_ecommerce_etl_pipeline, new_pipeline_id
from application.src.store.meta_mysql import list_pipelines, upsert_pipeline


def main() -> None:
    pipeline = get_ecommerce_etl_pipeline(pipeline_id=new_pipeline_id())
